        ...
        <div class="border p-10 border-grey-light shadow rounded">
            ...
            <form @submit.prevent="signup">
                ...
                <div class="mb-6">
                    ...
                    <input type="email" v-model="email" class="input" id="email" placeholder="any@web.com">
                </div>
                ...
                bg-green hover:bg-green-dark block w-full py-4 text-white items-center justify-center">Sign Un</button>
...
export default {
  ...
  methods: {
    signup () {
      this.$http.plain.post('/signup', { email: this.email, pasword: this.pasword, password_confirmation: this.password_confirmation })
